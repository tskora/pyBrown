...
int overlap_pbc(double ai, double aj, double rx, double ry, double rz, double box_length, double overlap_treshold);

double distance_pbc(double rx, double ry, double rz, double box_length);
